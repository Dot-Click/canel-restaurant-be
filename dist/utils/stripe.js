...
exports.supportedCountries = exports.getExchangeRate = exports.validateMinimumThreshold = exports.toCents = void 0;
const logger_util_1 = require("./logger.util");
const axios_1 = __importDefault(require("axios"));
const toCents = (amount) => amount * 100;
exports.toCents = toCents;
const validateMinimumThreshold = (options, callback) => {
    ...
    const error = new Error(`minimum amount should be ${rateToFiftyCentsEquivalent} ${exports.supportedCountries[country]}`);
    callback(isMinimumThreshold ? null : error, convertToCents
        ? (0, exports.toCents)(rateToFiftyCentsEquivalent)
        : rateToFiftyCentsEquivalent);
};
exports.validateMinimumThreshold = validateMinimumThreshold;
const getExchangeRate = (from, to) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const url = `https://open.er-api.com/v6/latest/${exports.supportedCountries[from]}`;
        const response = yield (yield axios_1.default.get(url)).data;
        if (response.result === "success") {
            const rates = response.rates;
            return rates[exports.supportedCountries[to]];
        }
